...
## Lab Instructions
**NOTE**: This lab assumes you have both Unity Hub and Unity version **6000.3.18f1** installed. If this is not the case, please refer to [Lab 0].

### Setting up your project (practice)
When you open up Unity, you should see something like this. Click on the New project button on the top right hand corner: Make sure you select version **6000.3.18f1**, as this is the version that the labs in this class will be working under.
